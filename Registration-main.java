	...
	public static void main(String[] args)
	 {
		...
		String pid=ob.next();
		class32 a=new class32(); //creating object for other class
		a.setname(name);//using set method update the values
		a.setadd(address);
		a.setphone(ph);
		a.setemail(email);
		a.setprooft(ptype);
		a.setproofid(pid);
		System.out.println("Name "+a.getname());//using get method retrive values
